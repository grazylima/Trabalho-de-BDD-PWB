...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <a href="loginP.php" class="get-started-btn scrollto">Voltar</a>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero" class="d-flex align-items-center justify-content-space-evenly">
    <div class="container" data-aos="fade-up">

      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1>Seja sustentável<span>!</span></h1>
          <h2>Faça seu cadastro</h2><p>
          <br>
          <div class='caixa'>
          <div class="box">
          ...
          <p>Foto: <input type='file' name='foto'></p><br>
...
<?php
	...
	if(isset($_GET['email'])){
		...
		$nome=$_GET['nome'];
		$foto=$_GET['foto'];
    $buscar=mysqli_query($conectar, "SELECT email FROM cadastro WHERE email='$email';");
    if(mysqli_num_rows($buscar) == 0){
      $inserir=mysqli_query($conectar,"insert into cadastro (email, senha, nome, foto) values('$email','$senha','$nome','$foto');");

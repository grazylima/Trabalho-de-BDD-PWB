    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          ...
          <h2>Selecione uma empresa</h2><p>
            <form action='alterar_emp_p.php' method='get'>
                <div class='rolagem'>
                    <?php
                        ...
                        if(mysqli_num_rows($buscar)==0)
                            ...
                            while($encontrou=mysqli_fetch_array($buscar)){
                                echo "<input type='radio' name='sele' value='$encontrou[0]'>";
                ...
                <br> <br> <br>
                <input type='submit' name='cadastro' value='Selecionar'>
            </form>
        </div>
      </div>

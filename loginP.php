...
<body>
  ...
  <h2>Faça seu login</h2><p>
  <br>
  <div class='caixa'>
    <div class="box">
      <form action='' method='POST'>
      <div class="input-container">
        <input type="text" required="" name='usuario' autocomplete='off'/>
      ...
      <div class="input-container">   
       ...
       <p>
       <p>Não tem login? <a href='cadastro.php'Cadastre-se!> Cadastre-se! </a><p>
      </form>
    </div>
  </div>
  </section><!-- End Hero -->
...
<?php
	...
	if(isset($_POST['usuario'])){
		...
		$senha=$_POST['senha'];
		$loginUsuario = mysqli_query($conectar,"select * from cadastro where nome='$usuario' && senha='$senha'");
		$loginEmail = mysqli_query($conectar,"select * from cadastro where email='$usuario' && senha='$senha'");
		
		if(mysqli_num_rows($loginUsuario) + mysqli_num_rows($loginEmail) > 0){

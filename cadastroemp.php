    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          ...
          <h2>Faça o cadastro da empresa</h2><p>
          <br>
...
<?php
      ...
      if (isset($_GET['cadastro'])){
        ...
        $emp=mysqli_query($conectar, "select * from empresa where nome='$nome' && endereco='$endereco' && telefone='$telefone';");
    
          if(mysqli_num_rows($emp) == 0){
            $inserir=mysqli_query($conectar, "insert into empresa (nome, endereco, numero, bairro, cidade, telefone) 
            values ('$nome','$endereco','$numero','$bairro','$cidade','$telefone');");
            echo "<script>alert('Empresa cadastrada!');</script>";
          }
          else{
            echo "<script>alert('Essa empresa já foi cadastrada!');</script>";
          }
    }
?>
